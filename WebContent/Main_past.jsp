			...
			<table class="table">
				<thead>
					...
					<tr
						...
						<th
							style="text-align: left; height: 60px; background-color: #5D5D5D; font-size: 17px; width: 8%; color: white;">RANK</th>
				...
				<tr>
					...
					%>
					<td
						style="color: red; font-size: 20px; font-weight: bold; font-style: italic; text-align: center;">
						<%
							} else {
						%>
					
					<td
						style="font-size: 20px; font-weight: bold; font-style: italic; text-align: center;">
						<%
							}
						%><%=i + 1%></td>
					<td><a
						href="FreeChart.jsp?name=<%=gn.namearr.get(i)%>&img=<%=gi.imgarr.get(i)%>&star=<%=gs.stararr.get(i)%>"><img
							src="<%=gi.imgarr.get(i)%>"></a></td>
					<td><a
						href="FreeChart.jsp?name=<%=gn.namearr.get(i)%>&img=<%=gi.imgarr.get(i)%>&star=<%=gs.stararr.get(i)%>"
						style="color: black;"><%=gn.namearr.get(i)%></a></td>


					<td><a
						href="FreeChart.jsp?name=<%=gn.namearr.get(i + 50)%>&img=<%=gi.imgarr.get(i + 50)%>&star=<%=gs.stararr.get(i + 50)%>"><img
							src="<%=gi.imgarr.get(i + 50)%>"></a></td>
					<td><a
						href="FreeChart.jsp?name=<%=gn.namearr.get(i + 50)%>&img=<%=gi.imgarr.get(i + 50)%>&star=<%=gs.stararr.get(i + 50)%>"
						style="color: black;"><%=gn.namearr.get(i + 50)%></a></td>


					<td><a
						href="FreeChart.jsp?name=<%=gn.namearr.get(i + 100)%>&img=<%=gi.imgarr.get(i + 100)%>&star=<%=gs.stararr.get(i + 100)%>"><img
							src="<%=gi.imgarr.get(i + 100)%>"></a></td>
					<td><a
						href="FreeChart.jsp?name=<%=gn.namearr.get(i + 100)%>&img=<%=gi.imgarr.get(i + 100)%>&star=<%=gs.stararr.get(i + 100)%>"
						style="color: black;"><%=gn.namearr.get(i + 100)%></a></td>
